...
```bash
python3 .agents/skills/zh-lint/zh_lint.py <file1.md> [file2.md ...]
```
...
## 已知不掃的東西（不是漏掃，是刻意排除）
vendored skill 本體**不**在排除之列。[上游 ADR 0020](https://github.com/haoagentuse-glitch/Agentfile/blob/main/docs/adr/0020-vendored-skills-in-chinese.md) 之後它們都是中文，跟自寫技能一樣要掃。
