...
description: >-
  ...
  new UI ("sketch a pricing page", "generate a hero with 21st", "make me an X
...
metadata:
  agentfile-modification: "Replaced an angle-bracket placeholder in the description for Codex compatibility."
---
