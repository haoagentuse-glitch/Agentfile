...
fixture 放在 examples/experimental/rag-walkthrough/，不含 schemas。
schemas 只有 packages/experimental/records/experiments/schemas/ 一份。
測試會在暫存目錄組起來再驗證。
"""
...
WALKTHROUGH = _find("examples/experimental/rag-walkthrough")
